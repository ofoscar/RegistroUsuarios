...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <form class="form-inline" method="post" action="buscarcliente.php">
    <input class="form-control mr-sm-2" id="buscar" name="buscar" type="search" placeholder="Buscar Cliente por Clave" aria-label="Search">
